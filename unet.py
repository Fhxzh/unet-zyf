...
class myUnet(object):
	...
	def train(self):
		...
		model.fit(imgs_train, imgs_mask_train, batch_size=2, epochs=40, verbose=1,validation_split=0.2, shuffle=True, callbacks=[model_checkpoint])
	...
	def save_img(self):
		...
		imgs = np.load('test_demo/results/imgs_mask_test.npy')
		for i in range(imgs.shape[0]):
			img = imgs[i]
			img = array_to_img(img)
			img.save("test_demo/results/%d.jpg"%(i))
